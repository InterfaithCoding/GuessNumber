...
A *while statement* always has a : colon after the condition. 
On the next line we write the block of code that we want to be executed if the condition evaluates to True. 
